...
const SCALP_TAB_STUB: ScalpSnapshot = {
  ...
  session_policy: {
    ...
    wfo_continuous_eval_hours: 672,
    wfo_continuous_warmup_hours: 168,
    wfo_continuous_min_trades: 20,
    wfo_period_rank_metric: "total_pnl",
    wfo_pick_best_per_mode: true,
    param_tuner_interval_sec: 900,
    wfo_roll_span_hours: 840,
    wfo_min_trades: 20,
