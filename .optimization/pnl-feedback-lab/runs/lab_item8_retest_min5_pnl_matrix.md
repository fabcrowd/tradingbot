...
|--------|-----:|-----:|-----:|-----:|-----:|-----:|-----:|-----:|-----:|
| early | 0.00 [LOW_N] | -967.85 | 773.82 | -63.51 | -537.05 [LOW_N] | 124.09 [LOW_N] | -288.13 | 111.12 | -6.73 |
| mid | 8.94 [LOW_N] | -1,117.54 | 175.72 | -76.25 | 109.66 | 312.92 | 44.17 | -558.94 | 202.07 |
...
| Window | daviddtech_scalp | ema_momentum | ema_scalp | hull_suite | qqe_mod | rsi_reversion | squeeze_momentum | supertrend | utbot_alert |
|--------|-----:|-----:|-----:|-----:|-----:|-----:|-----:|-----:|-----:|
| early | 0.37 [LOW_N] | -0.29 | -0.89 | -0.10 | -0.17 | 0.11 [LOW_N] | -1.39 | -0.56 [LOW_N] | -0.08 |
| mid | 0.58 [LOW_N] | -1.57 | 0.71 | 0.58 | -0.41 | 0.80 [LOW_N] | -0.03 | 0.64 | 1.32 |
| late | 1.93 [LOW_N] | -0.16 | 0.97 | 1.43 | -1.44 | -0.71 [LOW_N] | 0.98 | 0.60 | -0.86 |
...
| Window | daviddtech_scalp | ema_momentum | ema_scalp | hull_suite | qqe_mod | rsi_reversion | squeeze_momentum | supertrend | utbot_alert |
|--------|-----:|-----:|-----:|-----:|-----:|-----:|-----:|-----:|-----:|
| early | -0.01 [LOW_N] | -0.04 | 0.01 | -0.01 | -0.00 | -0.01 [LOW_N] | -0.02 | -0.01 | -0.02 |
| mid | -0.01 [LOW_N] | -0.01 | -0.01 | -0.00 | -0.00 | 0.00 [LOW_N] | -0.01 | 0.00 | -0.01 |
| late | 0.02 [LOW_N] | 0.03 | -0.00 | -0.02 | -0.02 | -0.01 | -0.02 | -0.00 | -0.01 |
