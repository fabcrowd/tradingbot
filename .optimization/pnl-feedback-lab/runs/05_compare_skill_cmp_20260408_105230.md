# Compare — run `agent_skill_cmp_20260408_105230`

**Generated:** 2026-04-08 14:52Z (auto)
**Git:** `813c83e`
...
| Field | Value |
|-------|-------|
| Command | `.optimization/pnl-feedback-lab/scripts/run_multiwindow_lab.py --intervals 5,15,60 --jsonl-out .optimization/pnl-feedback-lab/runs/lab_run_skill_cmp_20260408_105230.jsonl --compare-md .optimization/pnl-feedback-lab/runs/05_compare_skill_cmp_20260408_105230.md --export-pnl-details --run-id agent_skill_cmp_20260408_105230` |
| Artifacts | `.optimization\pnl-feedback-lab\runs\lab_run_skill_cmp_20260408_105230.jsonl` (+ stderr from same run) |
...
| 15m | mid | rsi_reversion | 739.188271 | 2 | — |
| 15m | late | ema_momentum | 3069.736156 | 26 | 1.9002 |
...
| 15m | mid | daviddtech_scalp | 0.294266 | 1 | — |
| 15m | late | ema_momentum | 4.400652 | 23 | 2.0199 |
...
**Weakest window (focus):** `late` (total_pnl=0.0). **Thin sample (trades<5):** early, mid, late.
...
| 15m | mid | rsi_reversion | 0.013242 | 2 | — |
| 15m | late | rsi_reversion | 0.011989 | 7 | 1.4499 |
...
|-------|--------|
| G1 (≥5 trades per window) | **FAIL** — 0/3 windows |
| G3 (profit factor ≥ 1 where finite) | **FAIL** — 1/2 windows with finite PF |
...
2. Windows with PF < 1: late — review mode or gates before scaling live.
